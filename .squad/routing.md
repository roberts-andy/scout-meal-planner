...
|-----------|----------|----------|
| Frontend UI, components, styling | Data | React components, Tailwind, Radix UI, TanStack Query hooks |
| Backend API, database, functions | Mouth | Azure Functions, Cosmos DB, Zod schemas, API endpoints |
| Architecture, code review, triage | Mikey | PR reviews, design decisions, issue triage, scope calls |
| Testing, quality, edge cases | Stef | Vitest unit tests, Playwright e2e, test coverage |
